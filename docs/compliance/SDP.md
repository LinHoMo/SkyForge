...
| 工具 | 用途 | 当前覆盖 |
|------|------|---------|
| **pytest** | 后端 / 引擎 / LLM 安全测试 | 当前验证 645 项通过 + 2 skipped |
| **Vitest** | 前端测试 | 当前验证 180 项通过（15 文件） |
...
| V1.0 | 2026-07-21 | 数据耦合/控制耦合分析 + 独立文档拆分 | 耦合分析器可用，8份独立文档完整 |
...
| M5: 版本发布 | 2026-07-20 | 全量开源 + 演示材料 | 全体成员 | 待开始 |
| M6: V1.0 P0 | 2026-07-21 | 耦合分析 + 独立文档 | 开发团队 | 进行中 |
