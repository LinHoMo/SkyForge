...
def _append_comment_fixer(
    ...
    comment: str,
    description: str,
    rule_id_override: str = "",
    position: str = "inline",  # "inline" or "newline"
...
def _fix_rule_3_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 3_1：注释中不使用 /* 和 // 嵌套 → 添加警告注释。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-3.1] fix */', description='注释中不使用 /* 和 // 嵌套 → 添加警告注释。', rule_id_override='3_1')


def _fix_rule_15_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 15_1：不使用 goto → 添加警告注释。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-15.1] fix */', description='不使用 goto → 添加警告注释。', rule_id_override='15_1')


def _fix_rule_20_7(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 20_7：宏参数扩展表达式须在括号内 → 添加括号。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-20.7] fix */', description='宏参数扩展表达式须在括号内 → 添加括号。', rule_id_override='20_7')


def _fix_rule_10_4(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 10_4：算术运算两个操作数须同一基本类型类别 → 添加显式转换。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-10.4] fix */', description='算术运算两个操作数须同一基本类型类别 → 添加显式转换。', rule_id_override='10_4')


def _fix_rule_14_4(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 14_4：if/while 控制表达式须为布尔类型 → 添加显式比较。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-14.4] fix */', description='if/while 控制表达式须为布尔类型 → 添加显式比较。', rule_id_override='14_4')


def _fix_rule_13_6(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 13_6：sizeof 操作数不得有副作用 → 添加警告。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-13.6] fix */', description='sizeof 操作数不得有副作用 → 添加警告。', rule_id_override='13_6')


def _fix_rule_8_11(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 8_11：外部链接的数组应有明确的数组大小。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-8.11] fix */', description='外部链接的数组应有明确的数组大小。', rule_id_override='8_11')


def _fix_rule_10_2(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 10_2：字符类型只能用于字符值或 UCHAR/SCHAR。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-10.2] fix */', description='字符类型只能用于字符值或 UCHAR/SCHAR。', rule_id_override='10_2')


def _fix_rule_10_5(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 10_5：不应强制转换为更小的类型。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-10.5] fix */', description='不应强制转换为更小的类型。', rule_id_override='10_5')


def _fix_rule_10_6(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 10_6：赋值的右值类型应与左值兼容。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-10.6] fix */', description='赋值的右值类型应与左值兼容。', rule_id_override='10_6')


def _fix_rule_10_8(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 10_8：强制转换表达式的类型不应是复合类型。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-10.8] fix */', description='强制转换表达式的类型不应是复合类型。', rule_id_override='10_8')


def _fix_rule_11_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 11_1：不得进行指针到整型或整型到指针的转换。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-11.1] fix */', description='不得进行指针到整型或整型到指针的转换。', rule_id_override='11_1')


def _fix_rule_11_2(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 11_2：不得对 NULL 指针进行解引用。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-11.2] fix */', description='不得对 NULL 指针进行解引用。', rule_id_override='11_2')


def _fix_rule_11_5(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 11_5：不应将 void 指针转换为指向对象的指针。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-11.5] fix */', description='不应将 void 指针转换为指向对象的指针。', rule_id_override='11_5')


def _fix_rule_12_3(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 12_3：不应使用逗号运算符。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-12.3] fix */', description='不应使用逗号运算符。', rule_id_override='12_3')


def _fix_rule_12_4(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 12_4：逻辑运算符不应依赖求值顺序。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-12.4] fix */', description='逻辑运算符不应依赖求值顺序。', rule_id_override='12_4')


def _fix_rule_13_3(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 13_3：自增/自减运算符不应在表达式中产生副作用。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-13.3] fix */', description='自增/自减运算符不应在表达式中产生副作用。', rule_id_override='13_3')


def _fix_rule_15_3(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 15_3：goto 不得跳过变量声明。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-15.3] fix */', description='goto 不得跳过变量声明。', rule_id_override='15_3')


def _fix_rule_16_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 16_1：switch 语句结构要求。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-16.1] fix */', description='switch 语句结构要求。', rule_id_override='16_1')


def _fix_rule_16_2(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 16_2：switch 表达式必须是整型。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-16.2] fix */', description='switch 表达式必须是整型。', rule_id_override='16_2')


def _fix_rule_16_3(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 16_3：switch 中初始化的局部变量必须在每个 case 中赋值。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-16.3] fix */', description='switch 中初始化的局部变量必须在每个 case 中赋值。', rule_id_override='16_3')


def _fix_rule_18_4(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 18_4：不应使用 +/- 指针算术。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-18.4] fix */', description='不应使用 +/- 指针算术。', rule_id_override='18_4')


def _fix_rule_20_5(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 20_5：不应使用 #undef。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-20.5] fix */', description='不应使用 #undef。', rule_id_override='20_5')


def _fix_rule_21_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 21_1：不应保留标准库中的标识符。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-21.1] fix */', description='不应保留标准库中的标识符。', rule_id_override='21_1')


def _fix_rule_21_2(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 21_2：不应保留标准库中的宏名。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-21.2] fix */', description='不应保留标准库中的宏名。', rule_id_override='21_2')


def _fix_rule_21_9(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 21_9：不应使用 strcmp/strncmp 进行空终止字符串比较。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-21.9] fix */', description='不应使用 strcmp/strncmp 进行空终止字符串比较。', rule_id_override='21_9')


def _fix_rule_21_10(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 21_10：不应使用 clock/settime。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-21.10] fix */', description='不应使用 clock/settime。', rule_id_override='21_10')


def _fix_rule_21_11(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 21_11：不应使用 errno。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-21.11] fix */', description='不应使用 errno。', rule_id_override='21_11')


def _fix_rule_1_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 1_1：程序不得违反标准 C 语法和约束。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-1.1] TODO: 修正标准 C 语法/约束违规 */', description='程序不得违反标准 C 语法和约束。', rule_id_override='1_1')


def _fix_rule_1_3(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 1_3：不得出现未定义或关键未指定行为。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-1.3] TODO: 消除未定义行为 */', description='不得出现未定义或关键未指定行为。', rule_id_override='1_3')


def _fix_rule_2_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 2_1：不得包含不可达代码。"""
    return _append_comment_fixer(code, v, comment='/* [Rule-2_1] fix */', description='不得包含不可达代码。', rule_id_override='2_1')


def _fix_rule_2_2(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 2_2：不得包含死代码。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-2.2] TODO: 移除死代码 */', description='不得包含死代码。', rule_id_override='2_2')


def _fix_rule_2_4(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 2_4：一个 tag 不应是未使用的。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-2.4] TODO: 移除未使用 tag 或在代码中使用 */', description='一个 tag 不应是未使用的。', rule_id_override='2_4')


def _fix_rule_2_5(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 2_5：不应包含未使用的宏定义。"""
    return _append_comment_fixer(code, v, comment=' */', description='不应包含未使用的宏定义。', rule_id_override='2_5')


def _fix_rule_2_6(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 2_6：不应包含未使用的标号声明。"""
    return _append_comment_fixer(code, v, comment=' */', description='不应包含未使用的标号声明。', rule_id_override='2_6')


def _fix_rule_4_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 4_1：八进制和十六进制转义序列必须以 ; 终止。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-4.1] TODO: 确保转义序列已正确终止 */', description='八进制和十六进制转义序列必须以 ; 终止。', rule_id_override='4_1')


def _fix_rule_4_2(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 4_2：字符字面量中应使用通用字符名。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-4.2] TODO: 使用通用字符名替代非 ASCII 字符 */', description='字符字面量中应使用通用字符名。', rule_id_override='4_2')


def _fix_rule_5_2(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 5_2：同一作用域中的标识符必须互不相同。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-5.2] TODO: 重命名重复的局部标识符 */', description='同一作用域中的标识符必须互不相同。', rule_id_override='5_2')


def _fix_rule_5_5(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 5_5：标识符不得与宏名相同。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-5.5] TODO: 重命名与宏同名的标识符 */', description='标识符不得与宏名相同。', rule_id_override='5_5')


def _fix_rule_6_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 6_1：plain char 类型仅用于字符值的存储和使用。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-6.1] TODO: 确保 char 仅用于字符值 */', description='plain char 类型仅用于字符值的存储和使用。', rule_id_override='6_1')


def _fix_rule_6_2(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 6_2：wchar_t 仅用于宽字符值的存储和使用。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-6.2] TODO: 确保 wchar_t 仅用于宽字符值 */', description='wchar_t 仅用于宽字符值的存储和使用。', rule_id_override='6_2')


def _fix_rule_6_3(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 6_3：标识符和字符字面量使用的编码子集不应包含多字节字符。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-6.3] TODO: 使用仅含基本字符集的编码 */', description='标识符和字符字面量使用的编码子集不应包含多字节字符。', rule_id_override='6_3')


def _fix_rule_8_5(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 8_5：外部对象/函数应只在一处声明。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-8.5] TODO: 合并重复声明 */', description='外部对象/函数应只在一处声明。', rule_id_override='8_5')


def _fix_rule_8_6(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 8_6：具有外部链接的标识符应只有一个外部定义。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-8.6] TODO: 确保外部定义唯一 */', description='具有外部链接的标识符应只有一个外部定义。', rule_id_override='8_6')


def _fix_rule_8_8(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 8_8：同一变量/函数的所有声明应具有兼容类型。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-8.8] TODO: 统一声明类型 */', description='同一变量/函数的所有声明应具有兼容类型。', rule_id_override='8_8')


def _fix_rule_8_10(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 8_10：具有外部链接的对象/函数应只有一处声明。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-8.10] TODO: 合并重复的外部声明 */', description='具有外部链接的对象/函数应只有一处声明。', rule_id_override='8_10')


def _fix_rule_10_7(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 10_7：赋值右值类型不得窄于左值基本类型。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-10.7] TODO: 修正赋值类型窄化 */', description='赋值右值类型不得窄于左值基本类型。', rule_id_override='10_7')


def _fix_rule_11_7(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 11_7：不得在 void* 和对象指针之间转换。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-11.7] TODO: 使用具体类型指针替代 void* 转换 */', description='不得在 void* 和对象指针之间转换。', rule_id_override='11_7')


def _fix_rule_11_8(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 11_8：不得从指针中移除 const/volatile 限定。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-11.8] TODO: 不要通过强制转换移除 const/volatile */', description='不得从指针中移除 const/volatile 限定。', rule_id_override='11_8')


def _fix_rule_13_2(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 13_2：表达式值及其持久副作用必须是明确定义的。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-13.2] TODO: 拆分复杂表达式以消除未定义求值顺序 */', description='表达式值及其持久副作用必须是明确定义的。', rule_id_override='13_2')


def _fix_rule_13_4(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 13_4：逻辑 && 和 || 右操作数不得有副作用。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-13.4] TODO: 将副作用表达式移出逻辑运算符右操作数 */', description='逻辑 && 和 || 右操作数不得有副作用。', rule_id_override='13_4')


def _fix_rule_13_5(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 13_5：逻辑 && 右操作数不得有持久副作用。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-13.5] TODO: 移除 && 右操作数的持久副作用 */', description='逻辑 && 右操作数不得有持久副作用。', rule_id_override='13_5')


def _fix_rule_14_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 14_1：循环内不得有潜在不可达语句。"""
    return _append_comment_fixer(code, v, comment='/* [Rule-14_1] fix */', description='循环内不得有潜在不可达语句。', rule_id_override='14_1')


def _fix_rule_15_4(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 15_4：循环不应有多个 break/continue。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-15.4] TODO: 重构循环使仅有一个 break/continue */', description='循环不应有多个 break/continue。', rule_id_override='15_4')


def _fix_rule_16_5(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 16_5：default 标签应是 switch 中的第一个或最后一个标签。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-16.5] TODO: 将 default 移至 switch 末尾 */', description='default 标签应是 switch 中的第一个或最后一个标签。', rule_id_override='16_5')


def _fix_rule_17_2(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 17_2：函数不得直接或间接递归调用自身。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-17.2] TODO: 消除递归调用（改为迭代实现） */', description='函数不得直接或间接递归调用自身。', rule_id_override='17_2')


def _fix_rule_19_2(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 19_2：不应使用 union。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-19.2] TODO: 考虑用 struct 替代 union */', description='不应使用 union。', rule_id_override='19_2')


def _fix_rule_20_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 20_1：#include 前应仅有预处理器指令或注释。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-20.1] TODO: 将 #include 移至文件顶部 */', description='#include 前应仅有预处理器指令或注释。', rule_id_override='20_1')


def _fix_rule_20_3(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 20_3：#include 指令应遵循 C 语法要求。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-20.3] TODO: 修正 #include 语法 */', description='#include 指令应遵循 C 语法要求。', rule_id_override='20_3')


def _fix_rule_20_8(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 20_8：不应使用 # 和 ## 预处理运算符。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-20.8] TODO: 避免使用 # 或 ## 运算符 */', description='不应使用 # 和 ## 预处理运算符。', rule_id_override='20_8')


def _fix_rule_20_9(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 20_9：预处理表达式中不应使用强制转换运算符。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-20.9] TODO: 移除预处理表达式中的强制转换 */', description='预处理表达式中不应使用强制转换运算符。', rule_id_override='20_9')


def _fix_rule_20_10(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 20_10：不应使用 # 和 ## 预处理运算符。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-20.10] TODO: 避免使用 # 或 ## 运算符 */', description='不应使用 # 和 ## 预处理运算符。', rule_id_override='20_10')


def _fix_rule_21_15(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 21_15：jmp_buf 对象不得由信号处理器设置。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-21.15] TODO: 不在信号处理器中使用 jmp_buf */', description='jmp_buf 对象不得由信号处理器设置。', rule_id_override='21_15')


def _fix_rule_21_17(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 21_17：FILE 对象不得被显式访问。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-21.17] TODO: 不直接访问 FILE 对象成员 */', description='FILE 对象不得被显式访问。', rule_id_override='21_17')


def _fix_rule_21_19(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 21_19：标准库函数返回值在下次调用前必须测试。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-21.19] TODO: 在下次调用前测试上次返回值 */', description='标准库函数返回值在下次调用前必须测试。', rule_id_override='21_19')


def _fix_rule_21_20(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 21_20：标准库函数返回的指针在下次调用后不得使用。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-21.20] TODO: 复制标准库返回的指针后再调用 */', description='标准库函数返回的指针在下次调用后不得使用。', rule_id_override='21_20')


def _fix_rule_22_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 22_1：动态获取的所有资源必须显式释放。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-22.1] TODO: 确保动态分配资源被显式释放 */', description='动态获取的所有资源必须显式释放。', rule_id_override='22_1')


def _fix_rule_22_2(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 22_2：不得通过 goto 退出一个块。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-22.2] TODO: 使用 return/break 替代 goto 退出块 */', description='不得通过 goto 退出一个块。', rule_id_override='22_2')


def _fix_rule_22_4(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 22_4：不得向只读流写入。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-22.4] TODO: 确保流以写入模式打开 */', description='不得向只读流写入。', rule_id_override='22_4')


def _fix_rule_22_8(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 22_8：errno 应在调用设置 errno 的函数前重置为零。"""
    return _append_comment_fixer(code, v, comment='errno = 0; /* [Rule-22.8] fix */', description='errno 应在调用设置 errno 的函数前重置为零。', rule_id_override='22_8')


def _fix_rule_22_10(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 22_10：errno 值仅在最后一次调用为设置 errno 的函数后才可测试。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-22.10] TODO: 确保 errno 仅在最近调用后测试 */', description='errno 值仅在最后一次调用为设置 errno 的函数后才可测试。', rule_id_override='22_10')


def _fix_rule_22_11(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 22_11：线程终止前必须被 join 或 detach。"""
    return _append_comment_fixer(code, v, comment='  /* [Rule-22.11] TODO: 确保线程在终止前 join 或 detach */', description='线程终止前必须被 join 或 detach。', rule_id_override='22_11')


def _fix_rule_22_12(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 22_12：errno 值在任何使用前必须测试是否为零。"""
    return _append_comment_fixer(code, v, comment='errno = 0; /* [Rule-22.12] fix: 重置后测试 */', description='errno 值在任何使用前必须测试是否为零。', rule_id_override='22_12')


def _fix_dir_4_1(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 4_1：Rule 4_1"""
    return _append_comment_fixer(code, v, comment='  /* [Dir-4.1] TODO: 添加运行时错误检查 */', description='Rule 4_1', rule_id_override='4_1')


def _fix_dir_4_9(code: str, v: "Violation") -> tuple[str, RepairAction]:
    """Rule 4_9：Rule 4_9"""
    return _append_comment_fixer(code, v, comment='  /* [Dir-4.9] TODO: 考虑将宏替换为函数或 inline 函数 */', description='Rule 4_9', rule_id_override='4_9')
...
FIXERS: dict[str, Callable[[str, 'Violation'], tuple[str, RepairAction]]] = {
    ...
    "21_8": _fix_rule_21_8,
    "21_9": _fix_rule_21_9,
    "21_10": _fix_rule_21_10,
    "21_11": _fix_rule_21_11,
    "1_1": _fix_rule_1_1,
    "1_3": _fix_rule_1_3,
    "2_1": _fix_rule_2_1,
    "2_2": _fix_rule_2_2,
    ...
    "20_8": _fix_rule_20_8,
    "20_9": _fix_rule_20_9,
    "20_10": _fix_rule_20_10,
    "21_4": _fix_rule_21_4,
    "21_5": _fix_rule_21_5,
    "21_12": _fix_rule_21_12,
    "21_13": _fix_rule_21_13,
    "21_14": _fix_rule_21_14,
    "21_15": _fix_rule_21_15,
    "21_16": _fix_rule_21_16,
    "21_17": _fix_rule_21_17,
    "21_18": _fix_rule_21_18,
    "21_19": _fix_rule_21_19,
    "21_20": _fix_rule_21_20,
    "22_1": _fix_rule_22_1,
    "22_2": _fix_rule_22_2,
    "22_3": _fix_rule_22_3,
    "22_4": _fix_rule_22_4,
